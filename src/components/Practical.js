                        ...
                        <div className='expInfo' key={index}>
                            ...
                            <div className="date-session">
                                <div className="start">
                                    ...
                                    <input type='date' id={`inputDateFrom${index}`} name='from' onChange={event => this.handleFormChange(index, event)} value={input.from} required></input>
                                </div>
                                <div className="finish">
                                    <label htmlFor={`inputDateUntil${index}`}>To: </label>
                                    <input type='date' id={`inputDateUntil${index}`} name='until' onChange={event => this.handleFormChange(index, event)} value={input.until} required></input>
                                </div>
                            </div>
